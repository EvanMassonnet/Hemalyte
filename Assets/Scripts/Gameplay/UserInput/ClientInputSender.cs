    ...
    public class ClientInputSender : NetworkBehaviour
    {
        ...
        void PerformSkill(ActionID actionID, SkillTriggerStyle triggerStyle, ulong targetId = 0)
        {
            ...
            else
            {
                ...
                //////// on utililise la souris pour clicker sur qqch ?
                int numHits = 0;
            ...
            ////// differente action du click suivant le contexte
        ...
        void Update()
        {
            if (_input.roll)
            {
                ...
                RequestAction(GameDataSource.Instance.RollActionPrototype, SkillTriggerStyle.MouseClick);
                _input.roll = false;
            }
            ...
            {
                //RequestAction(GameDataSource.Instance.PickUpActionPrototype, SkillTriggerStyle.MouseClick);
                RequestAction(CharacterClass.Skill2, SkillTriggerStyle.MouseClick);
                _input.toss= false;
            }
