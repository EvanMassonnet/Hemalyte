...
namespace Unity.BossRoom.Gameplay.Actions
{
    ...
    public class PickUpAction : Action
    {
        ...
        {
            Debug.Log("try pick up call");
            //Debug.DrawLine(parent.physicsWrapper.Transform.position, parent.physicsWrapper.Transform.position + parent.physicsWrapper.Transform.forward, Color.red, 5f);
            var numResults = Physics.RaycastNonAlloc(parent.physicsWrapper.Transform.position+new Vector3(0,1,0),
