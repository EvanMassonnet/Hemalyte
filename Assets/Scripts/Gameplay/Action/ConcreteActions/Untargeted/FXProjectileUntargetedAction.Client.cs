...
{
    public partial class FXProjectileUntargetedAction
    {
        ...
        FXProjectile SpawnAndInitializeProjectile(ClientCharacter parent)
        {
            ...
            var projectileGO = Object.Instantiate(Config.Projectiles[0].ProjectilePrefab, parent.transform.position + Config.FirePosition, parent.transform.rotation, null);
            ...
            projectile.Initialize(parent.transform.position + Config.FirePosition, m_TargetTransform, Data.Position, m_ProjectileDuration);
            return projectile;
        }
